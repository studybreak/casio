...
AbstractModel.prototype.toJSON = function(attributes){
    // console.log('Casio.toJSON', this._name)
    ...
    **/
    Model.prototype.initialize = function (attrs) {
        ...
        for (var name in this._schema) {
            ...
            if (attrs.constructor !== Object || attrs[name] === undefined) continue;
            ...
            switch(colDef.type) {
                case Boolean:
                    ...
                    // or not defined with a type boolean...
                    // it will come back as a string of 'true' or 'false'
    ...
    **/
    Model.property = function(p, type, opts){
      ...
      if (this.prototype[p] !== undefined) {
        throw new Error(this.prototype._name + '.' + p +
