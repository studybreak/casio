...
Casio.model = function(name, opts){
    ...
    **/
    ...
    /**
        Model.hasOne
            ...
            Example:
            // User.property('personId', Number, {has: 'person', as: Person});
    ...
    **/
    ...
    /**
        Model.hasMany
            ...
            Basically a list of belongsTo associations...
    ...
    **/
    ...
    /**
        Model.belongsTo
            ...
            model.primary is a primary key on another columnfamily
            ...
            if (results.length) {
                ...
                if (found){
                    ...
                    if (args.as === undefined){
                        ...
                        var loadHasOne = function loadHasOne(p) {
                            return function(next){
                                ...
                                if (klass.prototype.__type__==='Model'){
                                    ...
                                    new Error('Eager Loading for ModelArray is missing')
                        ...
                        // eager load a belongsTo association
    ...
    **/
    Model.prototype.update = function(args, callback){
        ...
        var colDef;
        for (var p in this._hasOne) {
            colDef = this._hasOne[p];
            console.log(colDef)
            if (this[p] !== undefined){
                var hasOne = this[p]
                this[colDef.fk] = hasOne[colDef.type.primary()]
            }
        }
...
// Casio Batch
/////////////////////////////////////
Casio.batch = function(name, opts){
    ...
    **/
    ...
    Batch.prototype.statement = function(){
